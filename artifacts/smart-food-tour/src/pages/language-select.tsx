...
export default function LanguageSelect() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 sm:p-8 overflow-hidden bg-background">
      ...
      <motion.div 
        ...
        className="relative z-10 w-full max-w-4xl bg-white/70 backdrop-blur-xl border border-white/40 shadow-2xl shadow-primary/10 rounded-3xl p-6 sm:p-10 flex flex-col items-center"
      >
        ...
        <div className="w-full max-w-md relative mb-8">
          ...
          <input 
            ...
            className="w-full pl-12 pr-4 py-4 bg-white/80 border-2 border-border/50 rounded-2xl focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all text-lg placeholder:text-muted-foreground/70 shadow-inner"
          />
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-border/50 w-full flex justify-center">
          <button 
            ...
            className="flex items-center gap-2 px-6 py-3 bg-foreground text-background rounded-xl font-medium hover:bg-foreground/90 transition-colors shadow-lg"
          >

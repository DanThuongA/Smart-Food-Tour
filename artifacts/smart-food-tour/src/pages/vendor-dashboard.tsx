...
import {
  ...
  Settings, LogOut, Volume2,
  Users, TrendingUp, Bell, Plus, Edit2, Trash2, CheckCircle, Clock, Menu
} from "lucide-react";
import {
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-center">
                      ...
                      <div className="flex gap-0.5 mt-1 justify-center">
                        {[1,2,3,4,5].map(i => (
                          <span key={i} className={`text-sm ${i <= 4 ? "text-orange-400" : "text-gray-200"}`}>★</span>
                        ))}
                      </div>

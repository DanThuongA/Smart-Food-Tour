...
function localize(venue, lang) {
    const nameLocal = venue.nameLocal;
    const descriptionLocal = venue.descriptionLocal;
    ...
    const menu = venue.menu.map((item) => {
        const itemNameLocal = item.nameLocal;
        return {
            ...item,
...
router.get("/audio/:venueId", (req, res) => {
    ...
    const transcripts = venue.audioTranscripts;
